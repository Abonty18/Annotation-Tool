...
SECRET_KEY = "django-insecure-!4*wj#kzeapzco6ortf95fx80-fp=re_a@1g=(u$rto-&yl4p+"
...
DATABASES={
     "default": {
        ...
        "NAME": 'railway',
        "USER":'postgres',
        "PASSWORD":'cnXKxylrbhpEsykjaqYgzydjYvLkmMSH',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'apikey'  # This is the string 'apikey', not the API key itself
